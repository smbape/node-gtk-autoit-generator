...
Func _g_dbus_menu_model_get_type()
    ; GType g_dbus_menu_model_get_type();
    Return _Gtk_DllCallResult(DllCall($_gtk_h_gio_dll, "uint64:cdecl", "g_dbus_menu_model_get_type"), "g_dbus_menu_model_get_type", @error)
EndFunc   ;==>_g_dbus_menu_model_get_type

Func _g_dbus_menu_model_get($connection, $bus_name, $object_path)
    ...
    EndIf
    Return _Gtk_DllCallResult(DllCall($_gtk_h_gio_dll, "ptr:cdecl", "g_dbus_menu_model_get", $sConnectionDllType, $connection, $sBus_nameDllType, $bus_name, $sObject_pathDllType, $object_path), "g_dbus_menu_model_get", @error)
EndFunc   ;==>_g_dbus_menu_model_get
